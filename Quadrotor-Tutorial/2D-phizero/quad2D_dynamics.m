function dx = quad2D_dynamics(t, x, p)
    ...
    % State derivative
    dx = [y_dot; z_dot; phi_dot; y_ddot; z_ddot; phi_ddot];
    
    % Deviation of states due to change in phi
    %dx = [y_dot; z_dot; phi_dot-1*dy/p.m; y_ddot; z_ddot; phi_ddot];
end
